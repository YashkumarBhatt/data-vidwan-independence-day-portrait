...
st.markdown('<p class="main-heading"><img src="https://i.ibb.co/FbLdv4bt/Data-Vidwan-Logo.jpg" style="height: 1em; vertical-align: middle; margin-right: 10px; margin-bottom: 5px;"> Data Vidwan Independence Day Portrait</p>', unsafe_allow_html=True)
